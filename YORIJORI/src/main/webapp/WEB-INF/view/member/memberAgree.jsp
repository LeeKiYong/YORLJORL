...
<div class="agree_container">
	<div class="agreeForm">
		<div class="agreeForm_body">
			<form method="post" action="member/join" name="agreeFrm">
				<p class="guide_txt2" style="padding-top:20px;">
					이용약관, 개인정보 수집 및 이용에 모두 동의합니다. 
					<input type="checkbox" id="allChk" value="1">
				</p>
				<div class="etc_line"></div>
				<p class="guide_txt2">YORIJORI 이용약관 동의
					<input type="checkbox" id="contractCheck" name="agree" value="1">
				</p>
				<textarea style="margin: 0px 20px; width: 447px; height: 219px;">
YORIJORI 이용약관은 다음과 같은 내용을 담고 있습니다. (2019년 12월 01일 시행)
제1조(목적)
이 약관은 전기통신사업법령 및 정보통신망이용촉진, 전자상거래 등에 관한 법령에 의하여 (주)XXX(이하 "회사"라 합니다)가 제공하는 YORIJORI의 서비스(이하 “서비스"라 한다) 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제2조(약관의 효력 및 변경)
...
제9조(계약사항의 변경)
(1) 회원은 개인정보수정(http://)을 통해 언제든지 개인정보를 열람하고 수정할 수 있습니다.
...
[부칙]
1. (시행일) 본 약관은 2019년 12월 01일부터 시행됩니다.
				</textarea>
				<p class="guide_txt2" style="padding-top:20px;">개인정보 수집 및 이용에 대한 안내
					<input type="checkbox" id="privacyCheck" value="1" />
				</p>
				<textarea style="margin: 0px 20px; width: 447px; height: 219px;">
(주)XXX(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 회사의 서비스를 이용하는 회원(이하 ‘이용자’라 한다) 의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다.
1. 총칙
...
가) 필수항목 : 아이디(ID), 비밀번호, 닉네임, 이메일주소, 성별, 생년월일 , 연락처
나) 선택항목 : 연락처2
...
사) 연락처(핸드폰 번호 or 일반전화번호), 주소 : 유료서비스·이벤트경품·쇼핑물품 등의 배송, 고지사항 전달, 기타 정보 서비스 제공
아) 은행계좌정보, 카드정보, 휴대폰번호 : 유료서비스 이용에 대한 요금 결제
...
- 전화번호 : XXX-XXX-XXXX
- 팩스번호 : XXX-XXX-XXXX
- 주 소 : 서울 영등포구 양평동3가 15-1 월드메르디앙비즈센터 4층 401 402호
- 이용자센터 : 사이트 내 고객센터
...
제19조 변경에 따른 공지의무
현 개인정보취급방침은 2019 년 12 월 01 일에 제정되었으며 정부의 정책 또는 보안기술의 변경에 따라 내용의 추가 삭제 및 수정이 있을 시에는 개정 최소 7일 전부터 홈페이지의 '공지사항'을 통해 고지할 것입니다.
가) 이 개인정보 처리방침은 2019년 12월 01일부터 적용됩니다.
				</textarea>
				<div>
					<input type="submit" value="동의" />
					<input type="button" value="비동의" onclick="localtion.href='../main'" />
				</div>
			</form>
		</div>
	</div>
